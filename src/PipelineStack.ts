...
export class PipelineStack extends Stack {
  ...
  pipeline(source: pipelines.CodePipelineSource, props: PipelineStackProps): pipelines.CodePipeline {
    const dockerHub = new Secret(this, 'docker-credentials', {
      description: `Docker credentials for ${Statics.projectName} (${props.configuration.branchName})`,
    });
    ...
    const pipelineName = `${Statics.projectName}-${props.configuration.branchName}`;
